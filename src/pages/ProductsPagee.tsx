...
const allProducts = [
    ...
    { id: 19, name: 'Pulse Oximeter Edan H100B', brand: 'Edan', category: 'Monitoring', image: 'https://www.edan.com/uploads/2021/11/17/1637138571.jpg' },
    { id: 20, name: 'Pulse Oximeter Contec CMS60D', brand: 'Contec', category: 'Monitoring', image: 'https://www.contecmed.com/uploads/soft/220421/1-2204211GQ2B2.jpg' },
    { id: 21, name: 'Handheld Pulse Oximeter', brand: 'Generic', category: 'Monitoring', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/handheld-pulse-oximeter-500x500.jpg' },
    { id: 22, name: 'Fingertip Pulse Oximeter (Benemed BX-11)', brand: 'Benemed', category: 'Monitoring', image: 'https://benemed.com/wp-content/uploads/2021/07/BX-11.jpg' },
    // Diagnostics
    { id: 4, name: 'Littmann Stethoscope Classic III', brand: '3M Littmann', category: 'Diagnostics', image: 'https://cdn.shopify.com/s/files/1/0012/8440/7394/files/littmann-classic-iii-stethoscope-black-edition-5803-littmann-30886582714466.webp?v=1727168831&width=400' },
    { id: 23, name: 'Infrared Thermometer Berrcom', brand: 'Berrcom', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/infrared-thermometer-500x500.jpg' },
    { id: 24, name: 'Infrared Thermometer Wiselion', brand: 'Wiselion', category: 'Diagnostics', image: 'https://www.wiselion.com.tw/upload/product/20200909155313_1.jpg' },
    { id: 25, name: 'Digital BP Monitor', brand: 'Omron', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2023/3/HT/AA/EP/783049/wrist-blood-pressure-monitor-500x500.jpg' },
    { id: 26, name: 'BP Machine Armstyle', brand: 'Generic', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2023/3/HT/AA/EP/783049/wrist-blood-pressure-monitor-500x500.jpg' },
    { id: 27, name: 'BP Machine Wrist (CK-101S)', brand: 'CK', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2023/3/HT/AA/EP/783049/wrist-blood-pressure-monitor-500x500.jpg' },
    { id: 28, name: 'BP Machine Wrist (CK-W132)', brand: 'CK', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2023/3/HT/AA/EP/783049/wrist-blood-pressure-monitor-500x500.jpg' },
    { id: 29, name: 'Blood Glucose Monitor Gluconavii', brand: 'Gluconavii', category: 'Diagnostics', image: 'https://www.gluconavii.com/wp-content/uploads/2019/07/DSC_0002-1.jpg' },
    { id: 30, name: 'Quantum Analyzer Gold', brand: 'Quantum', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/quantum-resonance-magnetic-analyzer-500x500.jpg' },
    { id: 31, name: 'Quantum Analyzer Black', brand: 'Quantum', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/quantum-resonance-magnetic-analyzer-500x500.jpg' },
    { id: 32, name: 'Tens Massager', brand: 'Generic', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/tens-massager-500x500.jpg' },
    { id: 33, name: 'Personal Weight Scale Digital', brand: 'Generic', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/digital-weight-scale-500x500.jpg' },
    { id: 34, name: 'Personal Weight Scale Manual', brand: 'Generic', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/manual-weight-scale-500x500.jpg' },
    { id: 35, name: 'Seca Weight Scale Seca 700', brand: 'Seca', category: 'Diagnostics', image: 'https://www.seca.com/fileadmin/_processed_/csm_700_01_2c7e2e2e7e.jpg' },
    { id: 36, name: 'Seca Weight and Height Scale Seca 777', brand: 'Seca', category: 'Diagnostics', image: 'https://www.seca.com/fileadmin/_processed_/csm_777_01_2c7e2e2e7e.jpg' },
    // Laboratory
    ...
    { id: 10, name: 'Vacutainer Needle', brand: 'BD', category: 'Laboratory', image: 'https://www.bd.com/resource.aspx?IDX=18313' },
    { id: 37, name: 'Test Tube Rack White', brand: 'Generic', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/test-tube-rack-500x500.jpg' },
    { id: 38, name: 'Test Tube Rack Pale Green', brand: 'Generic', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/test-tube-rack-500x500.jpg' },
    { id: 39, name: 'Falcon Tubes', brand: 'Falcon', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/falcon-tube-500x500.jpg' },
    { id: 40, name: 'Centrifuge Tubes', brand: 'Servicebio', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/centrifuge-tube-500x500.jpg' },
    { id: 41, name: 'Falcon Tube Large', brand: 'Falcon', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/falcon-tube-500x500.jpg' },
    { id: 42, name: 'Sterile Swab Stick', brand: 'Rabex', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/swab-stick-500x500.jpg' },
    { id: 43, name: 'Stool Container', brand: 'Generic', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/stool-container-500x500.jpg' },
    { id: 44, name: 'Timer TA732', brand: 'Generic', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/timer-500x500.jpg' },
    // ICU
    ...
    { id: 9, name: 'Emergency Ventilator', brand: 'Generic', category: 'ICU', image: 'https://www.usa.philips.com/c-dam/b2bhc/master/landing-pages/ventilator/philips-ventilator-ev300.jpg' },
    { id: 45, name: 'Infusion Pump Mindray (Benefusion Uvp)', brand: 'Mindray', category: 'ICU', image: 'https://www.mindraynorthamerica.com/wp-content/uploads/2020/09/benefusion-uVP-1.jpg' },
    { id: 46, name: 'Infusion Pump Mindray (Benefusion VP3)', brand: 'Mindray', category: 'ICU', image: 'https://www.mindraynorthamerica.com/wp-content/uploads/2020/09/benefusion-vp3-1.jpg' },
    { id: 47, name: 'Infrared Vein Finder XG-900', brand: 'Generic', category: 'ICU', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/vein-finder-500x500.jpg' },
    // Surgical
    ...
    { id: 48, name: 'Ambu Bag Infant/Neonate', brand: 'Generic', category: 'Surgical', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/ambu-bag-500x500.jpg' },
    { id: 49, name: 'Manual Resuscitator', brand: 'Generic', category: 'Surgical', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/manual-resuscitator-500x500.jpg' },
    { id: 50, name: 'Mama Delivery Kit', brand: 'Generic', category: 'Surgical', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/delivery-kit-500x500.jpg' },
    { id: 51, name: 'Surgical Equips', brand: 'Generic', category: 'Surgical', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/surgical-instruments-500x500.jpg' },
    // Mobility
    { id: 11, name: 'Hospital Bed', brand: 'Generic', category: 'Mobility', image: 'https://5.imimg.com/data5/SELLER/Default/2022/7/OG/GL/GL/1447260/hospital-bed-500x500.jpg' },
    { id: 12, name: 'Wheelchair', brand: 'Generic', category: 'Mobility', image: 'https://www.verywellhealth.com/thmb/0Qw1Qw8Qw8Qw8Qw8Qw8Qw8Qw8Qw=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/wheelchair-GettyImages-1147279562-5c7e2b8e46e0fb0001c6c1e2.jpg' },
    { id: 13, name: 'Crutches', brand: 'Generic', category: 'Mobility', image: 'https://www.verywellhealth.com/thmb/0Qw1Qw8Qw8Qw8Qw8Qw8Qw8Qw8Qw=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/crutches-GettyImages-1147279562-5c7e2b8e46e0fb0001c6c1e2.jpg' },
    { id: 14, name: 'Walking Aid', brand: 'Generic', category: 'Mobility', image: 'https://www.verywellhealth.com/thmb/0Qw1Qw8Qw8Qw8Qw8Qw8Qw8Qw8Qw=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/walker-GettyImages-1147279562-5c7e2b8e46e0fb0001c6c1e2.jpg' },
    { id: 15, name: 'Orthopaedic Support', brand: 'Generic', category: 'Orthopaedics', image: 'https://www.verywellhealth.com/thmb/0Qw1Qw8Qw8Qw8Qw8Qw8Qw8Qw8Qw=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/orthopedic-support-GettyImages-1147279562-5c7e2b8e46e0fb0001c6c1e2.jpg' },
    { id: 16, name: 'Commode Chair', brand: 'Generic', category: 'Mobility', image: 'https://5.imimg.com/data5/SELLER/Default/2022/7/OG/GL/GL/1447260/commode-chair-500x500.jpg' },
    { id: 17, name: 'Air Mattress', brand: 'Generic', category: 'Mobility', image: 'https://5.imimg.com/data5/SELLER/Default/2022/7/OG/GL/GL/1447260/air-mattress-500x500.jpg' },
    { id: 18, name: 'Nebulizer Machine', brand: 'Generic', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2022/7/OG/GL/GL/1447260/nebulizer-machine-500x500.jpg' },
    // Consumables
    { id: 52, name: 'Face Mask KN95 Folding', brand: 'Generic', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/kn95-face-mask-500x500.jpg' },
    { id: 53, name: 'Face Mask KN95', brand: 'Generic', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/kn95-face-mask-500x500.jpg' },
    { id: 54, name: 'Face Shield', brand: 'Generic', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/face-shield-500x500.jpg' },
    { id: 55, name: 'Cotton Wool Neosafe', brand: 'Neosafe', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/cotton-wool-500x500.jpg' },
    { id: 56, name: 'Cotton WOW Bandages Neosafe', brand: 'Neosafe', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/bandage-500x500.jpg' },
    { id: 57, name: 'Tongue Depressor Wooden Type', brand: 'Generic', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/tongue-depressor-500x500.jpg' },
    { id: 58, name: 'IV Cannula Neovac', brand: 'Neovac', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/iv-cannula-500x500.jpg' },
    { id: 59, name: 'Zinc Oxide Plaster', brand: 'Generic', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/zinc-oxide-plaster-500x500.jpg' },
    { id: 60, name: 'Biohazard Bags Red', brand: 'Generic', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/biohazard-bag-500x500.jpg' },
    { id: 61, name: 'Biohazard Bags Black', brand: 'Generic', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/biohazard-bag-500x500.jpg' },
    { id: 62, name: 'Biohazard Bags Yellow', brand: 'Generic', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/biohazard-bag-500x500.jpg' },
    { id: 63, name: 'Aniosept Tabs Laboratoires', brand: 'Laboratoires', category: 'Consumables', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/disinfectant-tablet-500x500.jpg' },
    // Miscellaneous
    { id: 64, name: 'First Aid Box', brand: 'Generic', category: 'Miscellaneous', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/first-aid-box-500x500.jpg' },
    { id: 65, name: 'Examination Light', brand: 'Generic', category: 'Miscellaneous', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/examination-light-500x500.jpg' },
    { id: 66, name: 'Florican Anklet', brand: 'Florican', category: 'Orthopaedics', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/anklet-500x500.jpg' },
    { id: 67, name: 'Sensors Probe', brand: 'Generic', category: 'Monitoring', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/sensor-probe-500x500.jpg' },
    { id: 68, name: 'Infant Sensor', brand: 'Generic', category: 'Monitoring', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/sensor-probe-500x500.jpg' },
    { id: 69, name: 'Rapid Diagnostic Test Medsource', brand: 'Medsource', category: 'Diagnostics', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/rapid-diagnostic-test-500x500.jpg' },
    { id: 70, name: 'Triple Blood Bag', brand: 'Generic', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/blood-bag-500x500.jpg' },
    { id: 71, name: 'Crocs', brand: 'Generic', category: 'Miscellaneous', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/crocs-500x500.jpg' },
    { id: 72, name: 'Yellow Tips', brand: 'Generic', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/yellow-tips-500x500.jpg' },
    { id: 73, name: 'Blue Tips', brand: 'Generic', category: 'Laboratory', image: 'https://5.imimg.com/data5/SELLER/Default/2021/7/ZW/UL/GL/1287260/blue-tips-500x500.jpg' },
];
const categories = [
